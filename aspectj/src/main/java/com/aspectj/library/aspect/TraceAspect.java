...
package com.aspectj.library.aspect;
...
import com.aspectj.library.internal.ChooseDialog;
...
public class TraceAspect {
    ...
    private static final String POINTCUT_CALL = "call(* com.aspectj.demo.component.MyFrameLayout.onMeasure(..))";
